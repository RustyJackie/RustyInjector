...
def main() -> None:
    ...
    # Wire up silent mode and colours before any output
    _log_mod._SILENT  = args.silent
    _log_mod._log_file = args.log
    setup_colors()
    ...
    try:
        if args.dry_run:
            ...
            injector = PtraceInjector(int(pid))
